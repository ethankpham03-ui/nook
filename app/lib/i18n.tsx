...
const englishCopy = {
  ...
  focus: {
    ...
    room: {
      title: 'Deep focus',
      minimize: 'Minimize',
      runningTitle: 'You’re in focus.',
      runningDescription: 'One intention. Everything else can wait.',
      pausedTitle: 'Focus is paused.',
      pausedDescription: 'Take a breath. Continue when you’re ready.',
      completedTitle: 'Your session is complete.',
      completedDescription: 'Your focused time has been saved on this device.',
      remaining: 'Time remaining',
      intentionFallback: 'A little space for one thing.',
      backToFocus: 'Back to Focus',
      completeEarly: 'Finish early',
      reset: 'Reset session',
      quickCapture: 'Quick capture',
      expand: 'Return to full focus',
      minimizeHint: 'Minimize or press Esc. Your timer keeps its state.',
    },
    notifications: {
      runningTitle: 'Focus in progress',
      runningBody: (intention: string, endTime: string) => `${intention} · Ends at ${endTime}`,
      pausedTitle: 'Focus paused',
      pausedBody: (intention: string) => `${intention} · Open Nook when you’re ready.`,
      completedTitle: 'Focus session complete',
      completedBody: (minutes: string) => `${minutes} saved on this device.`,
      underOneMinute: 'less than 1 min',
    },
    timer: {
      title: 'Focus timer',
  ...
  messages: {
    ...
    focusNotificationUnavailable: 'Install Nook and allow notifications in your device settings to receive focus alerts.',
...
const vietnameseCopy = {
  ...
  focus: {
    ...
    room: {
      title: 'Tập trung sâu',
      minimize: 'Thu nhỏ',
      runningTitle: 'Đang tập trung.',
      runningDescription: 'Chỉ một việc lúc này. Những việc khác có thể đợi.',
      pausedTitle: 'Đã tạm dừng.',
      pausedDescription: 'Nghỉ một chút. Tiếp tục khi bạn sẵn sàng.',
      completedTitle: 'Đã hoàn thành phiên.',
      completedDescription: 'Thời gian tập trung đã được lưu trên thiết bị này.',
      remaining: 'Thời gian còn lại',
      intentionFallback: 'Dành khoảng này cho một việc.',
      backToFocus: 'Trở về Tập trung',
      completeEarly: 'Hoàn thành sớm',
      reset: 'Đặt lại phiên',
      quickCapture: 'Ghi nhanh',
      expand: 'Trở lại toàn màn hình',
      minimizeHint: 'Thu nhỏ hoặc nhấn Esc. Bộ đếm giữ nguyên trạng thái.',
    },
    notifications: {
      runningTitle: 'Đang tập trung',
      runningBody: (intention: string, endTime: string) => `${intention} · Kết thúc lúc ${endTime}`,
      pausedTitle: 'Đã tạm dừng',
      pausedBody: (intention: string) => `${intention} · Mở Nook khi bạn sẵn sàng.`,
      completedTitle: 'Đã hoàn thành phiên tập trung',
      completedBody: (minutes: string) => `Đã lưu ${minutes} trên thiết bị.`,
      underOneMinute: 'dưới 1 phút',
    },
    timer: {
  ...
  messages: {
    ...
    focusNotificationUnavailable: 'Hãy cài Nook và cho phép thông báo trong cài đặt thiết bị để nhận nhắc nhở tập trung.',
    anchorSet: (movedPrevious: boolean) => movedPrevious
